import {
  addTodo, findById, toggleTodo, updateTodo,
...
test('toggleTodo should not modify', () => {
  const startTodo = {id: 2, name: 'two', isComplete: false};
  const result = toggleTodo(startTodo);
...
test('updateTodo should not update an item by id', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: false},
    {id: 3, name: 'three', isComplete: false}
...
test('removeTodo should not mutate the origina array', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: false},
    {id: 3, name: 'three', isComplete: false},
